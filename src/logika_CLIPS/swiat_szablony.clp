...
(deftemplate drogaKratki 
	...
	(slot kratka) ;wspó³rzedne kratki w której zawiera siê droga
	(slot kratkaY)
...
(deftemplate droga
	...
	(slot skadX) ;wspó³rzedne pierwszej klatki na drodze
	(slot skadY)
...
(deftemplate kleska
	(slot kratkaLGRX) ;wspó³rzedne obszaru kleski - lewy gorny rog
	(slot kratkaLGRY)
